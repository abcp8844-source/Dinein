    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      <ScrollView contentContainerStyle={{ padding: 25 }}>
        <View style={styles.header}>
          ...
          <Text style={{ color: colors.textDim, fontSize: 12 }}>Version 1.0.4 (Stable)</Text>
        </View>

        <View style={styles.section}>
          <Text style={[styles.label, { color: colors.primary }]}>ABOUT THE PLATFORM</Text>
          <Text style={[styles.description, { color: colors.textMain }]}>
            DiningTable is a premium ecosystem designed for seamless delivery and dine-in experiences. 
            We bridge the gap between quality food partners and elite customers with a focus on 
        ...
        <View style={styles.footer}>
          <Text style={{ color: colors.textDim, fontSize: 10, textAlign: 'center' }}>
...
const styles = StyleSheet.create({
  ...
  label: { fontSize: 10, fontWeight: 'bold', letterSpacing: 2, marginBottom: 15 },
