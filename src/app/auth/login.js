...
export default function Login() {
  ...
  const handleLogin = async () => {
    const isMasterAdmin =
      (email.toLowerCase() === "admin" || email === MASTER_ADMIN_EMAIL) &&
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.formArea}>
        ...
        <Text style={[styles.label, { color: colors.primary, marginTop: 15 }]}>
          SECURITY KEY
        </Text>
        <PremiumInput
          placeholder="••••••••"
      ...
      >
        ...
        <Text style={[styles.googleBtnText, { color: colors.primary }]}>
