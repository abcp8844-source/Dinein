    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        {globalRevenue.map((market, index) => (
          ...
          >
            <View>
              <Text style={styles.marketName}>{market.country.toUpperCase()}</Text>
        ...
        <TouchableOpacity style={styles.settleBtn}>
          <Text style={styles.settleText}>GENERATE GLOBAL FINANCIAL REPORT</Text>
        </TouchableOpacity>
      </ScrollView>
    </SafeAreaView>
  );
...
const styles = StyleSheet.create({
  ...
  header: { padding: 30, backgroundColor: '#050505', borderBottomWidth: 1, borderBottomColor: '#1A1A1A', alignItems: 'center' },
  ...
  settleText: { color: '#000', fontWeight: '900', fontSize: 11, letterSpacing: 1 }
});
