    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.mainBalanceCard}>
          ...
          <Text style={styles.amount}>${revenue.total.toLocaleString(undefined, {minimumFractionDigits: 2})}</Text>
        ...
        <View style={styles.statsGrid}>
          ...
          <View style={styles.statBox}>
            <MaterialCommunityIcons name="bullhorn-outline" size={24} color="#D4AF37" />
        ...
        <View style={styles.footerNote}>
          <MaterialCommunityIcons name="shield-check" size={16} color="#5D6D7E" />
          <Text style={styles.footerText}>SECURE TRANSACTION MONITORING ACTIVE</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  label: { color: "#5D6D7E", fontSize: 10, fontWeight: "900", letterSpacing: 2 },
  amount: { color: "#FFF", fontSize: 40, fontWeight: "900", marginVertical: 15 },
  divider: { height: 1, width: '40%', backgroundColor: '#1B2631', marginVertical: 10 },
  subLabel: { color: "#D4AF37", fontSize: 9, fontWeight: "700", letterSpacing: 1 },
  ...
  statLabel: { color: "#5D6D7E", fontSize: 8, fontWeight: "900", letterSpacing: 1, marginTop: 5 },
  footerNote: { 
    flexDirection: 'row', 
  ...
  footerText: { color: "#5D6D7E", fontSize: 9, fontWeight: "900", letterSpacing: 1 }
});
