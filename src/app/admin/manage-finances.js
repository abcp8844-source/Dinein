        ...
        renderItem={({ item }) => (
          <View style={styles.financeCard}>
            <View>
              ...
              <Text style={styles.balanceText}>Current: ${item.balance || 0}</Text>
            </View>
            <View style={styles.inputGroup}>
              ...
              />
              <TouchableOpacity onPress={() => updateBalance(item.id, item.tempBalance)}>
...
const styles = StyleSheet.create({
  ...
  financeCard: { backgroundColor: "#0A1A2F", padding: 15, borderRadius: 12, marginBottom: 10, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  ...
  input: { backgroundColor: "#1B2631", color: "#FFF", padding: 8, borderRadius: 8, width: 80, textAlign: 'center' }
});
