...
export default function AiAssistant() {
  ...
  const [messages, setMessages] = useState([
    { id: '1', text: `Hello! I am your Gemini Assistant. How can I help you discover the best food in ${userData?.location?.city || 'your area'} today?`, sender: 'ai' }
  ]);
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerTitleContainer}>
          ...
          <Text style={[styles.onlineStatus, {color: colors.primary}]}>● SYSTEM ONLINE</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  aiBubble: { alignSelf: 'flex-start', backgroundColor: '#0A0A0A', borderBottomLeftRadius: 2, borderWidth: 1, borderColor: '#111' },
  messageText: { fontSize: 14, lineHeight: 20, fontWeight: '500' },
  inputWrapper: { padding: 20, backgroundColor: '#000' },
  inputContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#0D0D0D', borderRadius: 25, paddingHorizontal: 20, paddingVertical: 10, borderWidth: 1, borderColor: '#111' },
