...
export default function Home() {
  ...
  const updateAiProtocol = () => {
    ...
    if (hours < 12) setAiMessage(`AM_PROTOCOL: OPTIMIZING ENERGY LEVELS IN ${location}.`);
    else if (hours < 18) setAiMessage(`SYSTEM_SYNC: HIGH-PERFORMANCE SELECTIONS DETECTED.`);
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <Animatable.View animation="fadeInDown" style={styles.header}>
          ...
          <Text style={styles.subTitle}>📍 {location.toUpperCase()} LOGISTICS</Text>
        </Animatable.View>
        ...
        <Animatable.View animation="pulse" iterationCount="infinite" style={styles.aiPanel}>
...
const styles = StyleSheet.create({
  ...
  subTitle: { fontSize: 8, fontWeight: "bold", letterSpacing: 2, marginTop: 5, color: "#D4AF37" },
  walletIconFrame: { padding: 8, backgroundColor: "#111", borderRadius: 12, borderWidth: 1, borderColor: "#222" },
  searchSection: { paddingHorizontal: 25, marginBottom: 10 },
  searchBar: { flexDirection: "row", alignItems: "center", paddingHorizontal: 20, height: 55, borderRadius: 15, backgroundColor: "#0A0A0A", borderWidth: 1, borderColor: "#111" },
  searchInput: { flex: 1, fontSize: 11, color: "#FFF", letterSpacing: 1 },
  aiPanel: { margin: 25, padding: 20, borderRadius: 20, backgroundColor: "#0A0A0A", borderWidth: 1, borderColor: "#D4AF3733" },
  aiLabel: { fontSize: 8, fontWeight: "900", letterSpacing: 2, marginBottom: 8, color: "#D4AF37" },
  aiText: { fontSize: 12, fontWeight: "600", color: "#FFF", letterSpacing: 0.5 },
  sectionTitle: { fontSize: 10, fontWeight: "900", marginHorizontal: 25, marginBottom: 20, letterSpacing: 3, color: "#444" },
  card: { flexDirection: "row", padding: 22, borderRadius: 20, backgroundColor: "#0A0A0A", borderWidth: 1, borderColor: "#111", marginBottom: 15, marginHorizontal: 25, alignItems: "center" },
  itemMeta: { flex: 1 },
  itemName: { fontSize: 14, fontWeight: "800", color: "#FFF", letterSpacing: 1 },
  distanceRow: { flexDirection: "row", alignItems: "center", marginTop: 6 },
  distanceText: { fontSize: 8, fontWeight: "bold", color: "#666", marginLeft: 4, letterSpacing: 1 },
  itemDesc: { fontSize: 10, marginTop: 8, color: "#444" },
  priceContainer: { alignItems: "flex-end" },
  priceTag: { fontWeight: "900", fontSize: 20, color: "#D4AF37" },
  currencyLabel: { fontSize: 8, fontWeight: "bold", color: "#D4AF37", opacity: 0.6 },
  loader: { marginTop: 50 },
