...
export default function ItemDetails() {
  ...
  const requestAdminHelp = () => {
    Alert.alert(
      "CORE SUPPORT",
      "ESTABLISH DIRECT LINK WITH SUPER ADMIN?",
      [
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <Animatable.View animation="fadeInDown" style={styles.header}>
          <View style={styles.titleRow}>
            ...
            <TouchableOpacity onPress={requestAdminHelp} style={styles.adminCircle}>
              <MaterialCommunityIcons name="robot-muffled" size={20} color="#D4AF37" />
            </TouchableOpacity>
          </View>
          ...
          <View style={styles.modeRow}>
            {["delivery", "dine_in"].map((mode) => (
              <TouchableOpacity
                ...
                style={[styles.modeBtn, orderMode === mode && styles.activeMode]}
              >
                <Ionicons
                ...
                />
                <Text style={[styles.modeText, { color: orderMode === mode ? "#000" : "#444" }]}>
        ...
        <Animatable.View animation="fadeIn" delay={400} style={styles.detailsBox}>
          <Text style={styles.descTitle}>ASSET SPECIFICATIONS</Text>
          <Text style={styles.description}>{description}</Text>
        </Animatable.View>

        <Animatable.View animation="pulse" iterationCount="infinite" style={styles.aiTrustBox}>
...
const styles = StyleSheet.create({
  ...
  adminCircle: { padding: 10, backgroundColor: "#0A0A0A", borderRadius: 50, borderWidth: 1, borderColor: "#111" },
  priceContainer: { flexDirection: "row", alignItems: "baseline", marginTop: 10 },
  price: { fontSize: 32, fontWeight: "300", color: "#D4AF37" },
  currencyLabel: { fontSize: 12, marginLeft: 8, fontWeight: "900", color: "#D4AF37", opacity: 0.6 },
  selectorContainer: { marginTop: 40 },
  sectionLabel: { fontSize: 9, fontWeight: "900", letterSpacing: 3, marginBottom: 20, color: "#333" },
  modeRow: { flexDirection: "row", justifyContent: "space-between" },
  modeBtn: { flex: 0.48, height: 65, borderRadius: 18, borderWidth: 1, borderColor: "#111", justifyContent: "center", alignItems: "center", flexDirection: "row" },
  activeMode: { backgroundColor: "#D4AF37", borderColor: "#D4AF37" },
  modeText: { fontSize: 10, fontWeight: "900", marginLeft: 10, letterSpacing: 1 },
  detailsBox: { marginTop: 45, padding: 25, backgroundColor: "#0A0A0A", borderRadius: 25, borderWidth: 1, borderColor: "#111" },
  descTitle: { fontSize: 8, fontWeight: "900", letterSpacing: 2, marginBottom: 15, color: "#D4AF37" },
  description: { fontSize: 14, lineHeight: 24, color: "#AAA", fontWeight: "400" },
  aiTrustBox: { marginTop: 40, padding: 20, backgroundColor: "#050505", borderRadius: 15, borderWidth: 1, borderColor: "#111" },
  aiTrustText: { color: "#222", fontSize: 8, fontWeight: "900", textAlign: "center", letterSpacing: 1 },
  footer: { marginTop: 50, paddingBottom: 20 },
  backBtn: { marginTop: 25, alignItems: "center" },
  cancelText: { fontSize: 10, fontWeight: "900", letterSpacing: 2, color: "#444" },
});
