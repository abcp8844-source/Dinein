...
export default function Wallet() {
  ...
  const getRegionalPaymentMethods = () => {
    ...
    return [
      ...(regionalMapping[country] || regionalMapping["Global"]),
      ...globalOptions,
    ];
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        >
          <Text style={[styles.label, { color: "#444" }]}>
            TOTAL LIQUIDITY ({country})
          </Text>
          {loading ? (
            ...
            {getRegionalPaymentMethods().map((method, index) => (
              ...
              >
                <View style={styles.methodInfo}>
                  ...
                  />
                  <Text style={[styles.methodText, { color: "#AAA" }]}>
                    {method}
                  </Text>
                </View>
                <Text style={[styles.connectLink, { color: colors.primary }]}>
                  ESTABLISH LINK
                </Text>
              </TouchableOpacity>
            ))}
