  ...
  const renderMessage = ({ item }) => (
    <Animatable.View 
      ...
      style={[
        ...
        item.sender === 'user' ? [styles.userBubble, {backgroundColor: '#111'}] : [styles.aiBubble, {borderColor: colors.primary}]
      ]}
    >
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerTitleContainer}>
          ...
          <View style={styles.statusRow}>
            ...
            <Text style={[styles.statusText, {color: colors.primary}]}>MARKET RADAR ACTIVE</Text>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 25, borderBottomWidth: 1, borderBottomColor: '#111' },
  headerTitleContainer: { alignItems: 'center' },
  headerTitle: { color: '#FFF', fontSize: 11, fontWeight: '900', letterSpacing: 3 },
  ...
  messageBubble: { maxWidth: '85%', padding: 20, borderRadius: 24, marginBottom: 20 },
  userBubble: { alignSelf: 'flex-end', borderBottomRightRadius: 2, borderWidth: 1, borderColor: '#222' },
