  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        ListEmptyComponent={<Text style={styles.emptyText}>NO ITEMS SELECTED</Text>}
      />
...
const styles = StyleSheet.create({
  ...
  emptyText: { color: '#A68D5F', textAlign: 'center', marginTop: 50, letterSpacing: 1 },
  footer: { borderTopWidth: 1, borderTopColor: '#D4AF37', paddingTop: 20, marginBottom: 20 },
