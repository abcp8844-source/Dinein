...
export default function OwnerPromotion() {
  ...
  const loadInventory = async () => {
    try {
      ...
      // Filtering based on active owner UID
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: THEME.bg }]}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity onPress={loadInventory}>
          <Ionicons name="refresh-circle-outline" size={30} color={THEME.accent} />
        </TouchableOpacity>
      </View>
...
const styles = StyleSheet.create({
  ...
  itemCard: { padding: 20, borderRadius: 18, marginBottom: 15, flexDirection: "row", justifyContent: "space-between", alignItems: "center", borderWidth: 1.5 },
  cardInfo: { flex: 1 },
  itemName: { fontSize: 17, fontWeight: "bold" },
  boostBtn: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 12, flexDirection: "row", alignItems: "center", borderWidth: 1, borderColor: "#D4AF37" },
